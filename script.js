...
// const diff = Math.abs(apples - grapes); //*   значення по модулю
// console.log(diff);
...
// console.log("\"це теж інтерполяція (за доп спец символів)\"");
// console.log('"sfsdf"');
...
//* FALSE: 0, пустрий рядок, null, undefined, NaN, false
